...
series_replacement = 'val seriesSites = listOf("TopCinema", "EgyDead TV10", "Egy Best", "ArabSeed Wine", "Laaroza", "Almeshkah", "QFilm", "ArabSeed", "CimaLight", "Stardima", "Brstej")'
...
for filepath in files_to_patch:
    try:
        ...
        with open(filepath, 'w') as f:
            f.write(content)
        print(f"Patched {filepath} with priority + fallbacks")
